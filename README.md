...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/zyshare/doubi/master/ssr.sh && chmod +x ssr.sh && bash ssr.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/zyshare/doubi/master/ssrmu.sh && chmod +x ssrmu.sh && bash ssrmu.sh
```
